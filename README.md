...
This project is a Requests Manager that shows requests that has to be delivered today and the next days. I lets the user add Requests, delete requests and search requests. 
